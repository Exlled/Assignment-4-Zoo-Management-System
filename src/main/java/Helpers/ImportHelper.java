...
public class ImportHelper {
    public static CompositeAnimalCollection createAnimals() {
        ...
        cougarsEnclosure.addAnimal(new Cougar("Sierra", 3, "F", 25)); // Add Sierra
        cougarsEnclosure.addAnimal(new Cougar("Rocky",  3, "M",  18)); // Add Rocky
        cougarsEnclosure.addAnimal(new Cougar("Luna",  2, "F", 23));  // Add Luna
        cougarsEnclosure.addAnimal(new Cougar("Lenny",  1, "M", 26));  // Add Lenny
